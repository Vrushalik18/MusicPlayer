...
import com.music.player.domain.use_case.welcomeMusicList.WelcomeViewModel
...
class MusicPlayer : AppCompatActivity() {
    private lateinit var welcomeFatchViewModel:WelcomeViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        welcomeFatchViewModel=ViewModelProvider(this).get(WelcomeViewModel::class.java)
